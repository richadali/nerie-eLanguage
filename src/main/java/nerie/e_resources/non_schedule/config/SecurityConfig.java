	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.cors(cors -> {
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/contact-us", "/nerie/e-resources/get-captcha", "/api/main-categories","/api/categories/**","/api/subcategories/**", // Added your API here
						...
						.hasRole("SUPERADMIN")
						.requestMatchers(HttpMethod.POST, "/nerie/e-resources/task-allotment")
						.hasRole("ADMIN")
						.requestMatchers("/nerie/e-resources/get-categories", "/nerie/e-resources/add-category",
								"/nerie/e-resources/edit-category", "/ajax/add-category.js", "/ajax/get-list-categories.js")
						.hasRole("ADMIN")
